...
export default function HomePage() {
  return (
    <section className="container mx-auto px-4 lg:px-8 py-12 md:py-24 flex flex-col md:flex-row items-center gap-16 min-h-[calc(100vh-80px)]">
      {/* Left Column: Headline and Storytelling */}
      <div className="flex-1 space-y-8 max-w-2xl">
        <h1 className="text-5xl md:text-8xl font-black text-charcoal leading-[1.05] tracking-tight uppercase">
          Mie Halus,<br />
          Lembut, & Tipis<br />
          <span className="text-gold">Tradisi Salatiga.</span>
        </h1>
        
        <div className="space-y-6 text-base md:text-lg text-zinc-500 leading-relaxed max-w-xl">
          <p>
          ...
          <p className="border-l-2 border-gold pl-4 italic text-zinc-600">
        ...
        <div className="pt-4">
          <Link
            href="/menu" 
            className="inline-flex items-center gap-3 bg-charcoal text-white font-extrabold px-8 py-5 rounded-full hover:bg-gold hover:text-charcoal transition-all duration-300 uppercase tracking-widest text-xs"
          >
      ...
      <div className="flex-1 w-full aspect-[4/5] md:h-[650px] bg-zinc-100 rounded-[2.5rem] overflow-hidden relative border border-zinc-200/50 shadow-sm flex items-center justify-center">
        ...
        <div className="text-center z-20 space-y-2 p-8">
          <span className="text-xs uppercase tracking-widest text-zinc-400 font-bold">Signature Dish</span>
          <h3 className="text-2xl font-black text-charcoal uppercase">Mie Ayam Komplit Sutra</h3>
        </div>
